...
public class ConcatFieldsTest {
    ...
    private class ConcatFieldsHandler extends ConcatFields {
        ...
        public ConcatFieldsHandler(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans, boolean useSuperHeader) {
    ...
    public void setUp() throws Exception {
        stepMockHelper = new StepMockHelper<ConcatFieldsMeta, ConcatFieldsData>("CONCAT FIELDS TEST", ConcatFieldsMeta.class, ConcatFieldsData.class);
    ...
    public void testPrepareOutputRow() throws Exception {
        ConcatFieldsHandler concatFields = new ConcatFieldsHandler(stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.transMeta, stepMockHelper.trans, false);
    ...
    public void testWriteHeaderWithoutFields() throws Exception {
        ...
        ConcatFieldsHandler concatFields = new ConcatFieldsHandler(stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.transMeta, stepMockHelper.trans, true);
        Object[] row = new Object[] {"one", "two"};
        concatFields.setRow(row);
        ...
        doCallRealMethod().when(stepMockHelper.processRowsStepMetaInterface).getFields(any(RowMetaInterface.class), any(String.class), any(), any(StepMeta.class), any(VariableSpace.class), any(Repository.class), any(IMetaStore.class));

        stepMockHelper.processRowsStepMetaInterface.setTargetFieldName("one");
        ...
        String headerString = new String(((ConcatFieldsOutputStream) stepMockHelper.processRowsStepDataInterface.writer).read());
