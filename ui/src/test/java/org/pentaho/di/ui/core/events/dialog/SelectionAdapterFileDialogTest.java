...
public class SelectionAdapterFileDialogTest {
    ...
    public void testGetRepositoryFilePath() {
        ...
        assertEquals(FilenameUtils.normalize("/home/devuser/files/food.txt"), testInstance.getRepositoryFilePath(fileDialogOperation));
    }

    @Test
    public void testConcat() {

        assertEquals(FilenameUtils.normalize("/home/devuser/files/food.txt"), testInstance.concat("/home/devuser/files", "food.txt"));

        assertEquals(FilenameUtils.normalize("/home/devuser/files/food.txt"), testInstance.concat("/home/devuser/files/", "food.txt"));

        assertEquals(FilenameUtils.normalize("/home/devuser/files/food.txt"), testInstance.concat("/", "home/devuser/files/food.txt"));

        assertEquals(FilenameUtils.normalize("/"), testInstance.concat("/", ""));

        assertEquals(FilenameUtils.normalize("/home/devuser/files/"), testInstance.concat("/home/devuser/files", ""));
    }
    ...
    public void testCleanFilters() {
        ...
        assertArrayEquals(new String[] {"TXT", "CSV"}, testInstance.cleanFilters(new String[] {FilterType.TXT.toString(), null, FilterType.CSV.toString(), ""}));

        assertArrayEquals(new String[] {"TXT", "CSV"}, testInstance.cleanFilters(new String[] {FilterType.TXT.toString(), FilterType.CSV.toString()}));
    }
    ...
    protected SelectionAdapterFileDialog createTestInstance(LogChannelInterface log, StringBuilder textWidget, AbstractMeta meta, SelectionAdapterOptions options, RepositoryUtility repositoryUtility, ExtensionPointWrapper extensionPointWrapper) {
    ...
    public static class TestSelectionAdapterFileDialog extends SelectionAdapterFileDialog<StringBuilder> {
        ...
        public TestSelectionAdapterFileDialog(LogChannelInterface log, StringBuilder textWidget, AbstractMeta meta, SelectionAdapterOptions options, RepositoryUtility repositoryUtility, ExtensionPointWrapper extensionPointWrapper) {
