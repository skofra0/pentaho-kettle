...
package plugin.deem.swt.fileopensave.providers.repository;
...
import plugin.deem.swt.fileopensave.api.providers.BaseFileProvider;
import plugin.deem.swt.fileopensave.api.providers.exception.FileException;
import plugin.deem.swt.fileopensave.api.providers.exception.FileExistsException;
import plugin.deem.swt.fileopensave.api.providers.exception.InvalidFileOperationException;
import plugin.deem.swt.fileopensave.api.providers.exception.InvalidFileTypeException;
import plugin.deem.swt.fileopensave.controllers.RepositoryBrowserController;
import plugin.deem.swt.fileopensave.providers.repository.model.RepositoryDirectory;
import plugin.deem.swt.fileopensave.providers.repository.model.RepositoryFile;
import plugin.deem.swt.fileopensave.providers.repository.model.RepositoryTree;
import plugin.deem.swt.fileopensave.util.Util;
...
public class RepositoryFileProvider extends BaseFileProvider<RepositoryFile> {
    ...
    @Override
    public boolean isSame(plugin.deem.swt.fileopensave.api.providers.File file1, plugin.deem.swt.fileopensave.api.providers.File file2) {
