...
package plugin.deem.swt.fileopensave.controllers;
...
import plugin.deem.swt.fileopensave.providers.repository.RepositoryFileProvider;
...
import plugin.deem.swt.fileopensave.providers.repository.model.RepositoryName;
...
public class RepositoryBrowserController {
  ...
  public List<plugin.deem.swt.fileopensave.providers.repository.model.RepositoryObject> search( String path, String filter ) {
    RepositoryDirectoryInterface repositoryDirectoryInterface = findDirectory( path );
    List<plugin.deem.swt.fileopensave.providers.repository.model.RepositoryObject> repositoryObjects = new ArrayList<>();
