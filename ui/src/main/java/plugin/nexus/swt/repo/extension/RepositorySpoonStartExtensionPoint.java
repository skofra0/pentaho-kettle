...
package plugin.nexus.swt.repo.extension;
...
import plugin.nexus.swt.repo.dialog.RepositoryDialog;
...
public class RepositorySpoonStartExtensionPoint implements ExtensionPointInterface {
    ...
    public RepositorySpoonStartExtensionPoint() {
        this.repositoryConnectController = new RepositoryConnectController();
    }
