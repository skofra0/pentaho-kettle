...
package plugin.nexus.swt.fileopensave.controllers;
...
import plugin.nexus.swt.fileopensave.providers.repository.RepositoryFileProvider;
...
import plugin.nexus.swt.fileopensave.providers.repository.model.RepositoryName;
...
public class RepositoryBrowserController {
  ...
  public List<plugin.nexus.swt.fileopensave.providers.repository.model.RepositoryObject> search( String path, String filter ) {
    RepositoryDirectoryInterface repositoryDirectoryInterface = findDirectory( path );
    List<plugin.nexus.swt.fileopensave.providers.repository.model.RepositoryObject> repositoryObjects = new ArrayList<>();
