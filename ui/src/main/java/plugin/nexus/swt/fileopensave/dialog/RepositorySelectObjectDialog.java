 ...
 * @since 19-06-2003
 */
public class RepositorySelectObjectDialog extends Dialog {
  private static Class<?> PKG = RepositoryDialogInterface.class; // for  i18n  purposes 
  ...
  public RepositorySelectObjectDialog( Shell parent, Repository rep ) {
    this( parent, rep, true, true );
  }

  public RepositorySelectObjectDialog( Shell parent, Repository rep, boolean showTransformations, boolean showJobs ) {
