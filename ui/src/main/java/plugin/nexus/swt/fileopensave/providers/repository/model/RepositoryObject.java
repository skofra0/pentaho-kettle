...
package plugin.nexus.swt.fileopensave.providers.repository.model;

import java.util.ArrayList;
import java.util.List;

import plugin.nexus.swt.fileopensave.api.providers.BaseEntity;
import plugin.nexus.swt.fileopensave.api.providers.File;
