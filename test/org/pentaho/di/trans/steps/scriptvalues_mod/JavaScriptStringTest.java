...
public class JavaScriptStringTest extends TestCase {
    ...
    public RowMetaInterface createRowMetaInterfaceResult1() {
        ...
        ValueMetaInterface[] valuesMeta = {new ValueMeta("string", ValueMeta.TYPE_STRING), new ValueMeta("original", ValueMeta.TYPE_STRING), new ValueMeta("ltrimStr", ValueMeta.TYPE_STRING), new ValueMeta("rtrimStr", ValueMeta.TYPE_STRING), new ValueMeta("trimStr", ValueMeta.TYPE_STRING),};
    ...
    public RowMetaInterface createRowMetaInterfaceResult2() {
        ...
        ValueMetaInterface[] valuesMeta = {new ValueMeta("string", ValueMeta.TYPE_STRING), new ValueMeta("lpadded1", ValueMeta.TYPE_STRING), new ValueMeta("lpadded2", ValueMeta.TYPE_STRING), new ValueMeta("rpadded1", ValueMeta.TYPE_STRING), new ValueMeta("rpadded2", ValueMeta.TYPE_STRING), new ValueMeta("upperStr", ValueMeta.TYPE_STRING), new ValueMeta("lowerStr", ValueMeta.TYPE_STRING),};
    ...
    public RowMetaInterface createRowMetaInterfaceResult3() {
        ...
        ValueMetaInterface[] valuesMeta = {new ValueMeta("string", ValueMeta.TYPE_STRING), new ValueMeta("numb1", ValueMeta.TYPE_NUMBER), new ValueMeta("bool1", ValueMeta.TYPE_BOOLEAN), new ValueMeta("str1", ValueMeta.TYPE_STRING),};
    ...
    public RowMetaInterface createRowMetaInterface2() {
        ...
        ValueMetaInterface[] valuesMeta = {new ValueMeta("string", ValueMeta.TYPE_STRING), new ValueMeta("search", ValueMeta.TYPE_STRING), new ValueMeta("offset1", ValueMeta.TYPE_INTEGER), new ValueMeta("offset2", ValueMeta.TYPE_INTEGER),};
    ...
    public RowMetaInterface createRowMetaInterfaceResult4() {
        ...
        ValueMetaInterface[] valuesMeta = {new ValueMeta("string", ValueMeta.TYPE_STRING), new ValueMeta("search", ValueMeta.TYPE_STRING), new ValueMeta("offset1", ValueMeta.TYPE_INTEGER), new ValueMeta("offset2", ValueMeta.TYPE_INTEGER), new ValueMeta("index1", ValueMeta.TYPE_INTEGER), new ValueMeta("index2", ValueMeta.TYPE_INTEGER), new ValueMeta("index3", ValueMeta.TYPE_INTEGER),};
    ...
    public List<RowMetaAndData> createResultData4() {
        ...
        Object[] r1 = new Object[] {"abcdefgh", "ef", Long.valueOf(3), Long.valueOf(10), Long.valueOf(4), Long.valueOf(4), Long.valueOf(-1)};
        Object[] r2 = new Object[] {"abcdefgh", "h", Long.valueOf(0), Long.valueOf(7), Long.valueOf(7), Long.valueOf(7), Long.valueOf(7)};
        Object[] r3 = new Object[] {"abcdefgh", "h", Long.valueOf(1), Long.valueOf(6), Long.valueOf(7), Long.valueOf(7), Long.valueOf(7)};
        Object[] r4 = new Object[] {"abcdefgh", null, Long.valueOf(1), Long.valueOf(2), Long.valueOf(-1), Long.valueOf(-1), Long.valueOf(-1)};
        Object[] r5 = new Object[] {"abcdefgh", "invalid", Long.valueOf(1), Long.valueOf(1), Long.valueOf(-1), Long.valueOf(-1), Long.valueOf(-1)};
        Object[] r6 = new Object[] {"abcdefgh", "invalidlonger", Long.valueOf(1), Long.valueOf(1), Long.valueOf(-1), Long.valueOf(-1), Long.valueOf(-1)};
