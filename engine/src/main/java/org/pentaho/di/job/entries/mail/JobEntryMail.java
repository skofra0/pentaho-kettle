    ...
    public Result execute(Result result, int nr) {
        ...
        try {
            if (usingConfig) {
                ...
                dataServer = Utils.toStringNullToEmpty(props.get("mail." + protocol + ".host"));
                dataAuthenticationUser = Utils.toStringNullToEmpty(props.get("mail." + protocol + ".user"));
                dataAuthenticationPassword = Utils.toStringNullToEmpty(props.get("mail." + protocol + ".password"));
                dataUsingAuthentication = Utils.toStringNullToEmpty(props.get("mail." + protocol + ".auth")).equalsIgnoreCase("true");
                dataPort = Utils.toStringNullToEmpty(props.get("mail." + protocol + ".port"));
            } else {
