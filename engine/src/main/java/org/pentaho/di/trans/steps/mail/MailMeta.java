...
public class MailMeta extends BaseStepMeta implements StepMetaInterface {
    ...
    private void readData(Node stepnode) {
        setConfigFile(XMLHandler.getTagValue(stepnode, "configFile")); // SKOFRA
    ...
    public String getXML() throws KettleException {
        ...
        retval.append("      ").append(XMLHandler.addTagValue("configFile", this.configFile)); // SKOFRA
    ...
    public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases) throws KettleException {
        try {
            ...
            this.configFile = rep.getStepAttributeString(id_step, "configFile"); // SKOFRA
    ...
    public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step) throws KettleException {
        try {
            rep.saveStepAttribute(id_transformation, id_step, "configFile", this.configFile); // SKOFRA
    ...
    public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String[] input, String[] output, RowMetaInterface info, VariableSpace space, Repository repository, IMetaStore metaStore) {
        ...
        // Servername
        if (Utils.isEmpty(server) && !isUsingConfigFile()) { // SKOFRA
        ...
        // port number
        if (Utils.isEmpty(port) && !isUsingConfigFile()) { // SKOFRA
