...
public class KettleDatabaseRepositoryNotePadDelegate extends KettleDatabaseRepositoryBaseDelegate {
  ...
  public synchronized ObjectId insertNote( String note, long gui_location_x, long gui_location_y,
    ...
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_X, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( gui_location_x ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_Y, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( gui_location_y ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_WIDTH, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( gui_location_width ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_GUI_LOCATION_HEIGHT, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( gui_location_height ) );
    // Font
    ...
    // Font color
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_COLOR_RED, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontcolorred ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_COLOR_GREEN, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontcolorgreen ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_COLOR_BLUE, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontcolorblue ) );
    // Font background color
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BACK_GROUND_COLOR_RED, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbackcolorred ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BACK_GROUND_COLOR_GREEN, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbackcolorgreen ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BACK_GROUND_COLOR_BLUE, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbackcolorblue ) );
    // Font border color
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BORDER_COLOR_RED, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbordercolorred ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BORDER_COLOR_GREEN, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbordercolorgreen ) );
    table.addValue( new ValueMeta( KettleDatabaseRepository.FIELD_NOTE_BORDER_COLOR_BLUE, ValueMetaInterface.TYPE_INTEGER ), Long.valueOf( fontbordercolorblue ) );
