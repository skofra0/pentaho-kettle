...
public class WebServiceMetaTest {
	...
	public void testLoadXml() throws Exception {
		...
		assertWebServiceField(fieldsOut.get(0), "GetCurrentExchangeRateResult", "GetCurrentExchangeRateResult",
				"decimal", 6);
	...
	public void testSaveRep() throws Exception {
		...
		verify(rep).saveStepAttribute(aTransId, aStepId, "wsUrl",
		...
		verify(rep).saveStepAttribute(aTransId, aStepId, "wsOperationNamespace",
	...
	private ArgumentMatcher<ValueMetaInterface> matchValueMetaString(final String fieldName) {
		return new ArgumentMatcher<ValueMetaInterface>() {
			@Override
			public boolean matches(ValueMetaInterface item) {
	...
	public void testCheck() throws Exception {
		...
		webServiceMeta.check(remarks, transMeta, stepMeta, prev, new String[] {}, null, info, new Variables(), rep,
				metastore);
		assertEquals(2, remarks.size());
	...
	public void testGetFieldOut() throws Exception {
		...
		assertEquals("GetCurrentExchangeRateResult",
