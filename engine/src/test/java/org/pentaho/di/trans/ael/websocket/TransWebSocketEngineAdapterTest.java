...
public class TransWebSocketEngineAdapterTest {
    ...
    public void testOpsIncludeSubTrans() throws Exception {
        ...
        TransWebSocketEngineAdapter adapter = new TransWebSocketEngineAdapter(transMeta, "", -1, false);
    ...
    public void testLoggingOnStep() throws KettleException {
        TransMeta transMeta = new TransMeta(getClass().getResource("grid-to-subtrans.ktr").getPath());
        TransWebSocketEngineAdapter adapter = new TransWebSocketEngineAdapter(transMeta, "", 0, false);
    ...
    private ArgumentMatcher<StopMessage> matchesSafeStop() {
        return new ArgumentMatcher<StopMessage>() {
            @Override
            public boolean matches(StopMessage o) {
