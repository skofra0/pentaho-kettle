...
public class MailTest {
    ...
    @Before
    public void setup() {
        stepMockHelper = new StepMockHelper<MailMeta, MailData>("Test Mail", MailMeta.class, MailData.class);
    ...
    private void validateMimeCharacters(Message message, File tempFile) throws Exception {
        ...
        assertTrue(((MimeMultipart) message.getContent()).getBodyPart(0).getHeader("Content-Disposition")[0].contains(SPECIAL_CHARS_FILE_ENCODED));
    ...
    public void testSendMailWithPassword(String authPassword) throws Exception {
        Mail step = spy(new Mail(stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.transMeta, stepMockHelper.trans));
        ...
        String[] strings = new String[] {SMTP_HOST_VALUE, SMTP_AUTH_USER_VALUE, authPassword, EMAIL_RECIPIENT_VALUE, EMAIL_SENDER_NAME_VALUE, EMAIL_SENDER_ADDRESS_VALUE, EMAIL_SUBJECT_VALUE, EMAIL_BODY_VALUE, SMTP_PORT_VALUE};
