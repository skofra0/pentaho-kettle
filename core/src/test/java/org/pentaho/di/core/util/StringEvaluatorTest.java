...
public class StringEvaluatorTest {
    ...
    public void testCustomDateFormat() {
        ...
        assertFalse(evaluator.getStringEvaluationResults().isEmpty());
        assertTrue(evaluator.getAdvicedResult().getConversionMeta().isDate());
        assertEquals(sampleFormat, evaluator.getAdvicedResult().getConversionMeta().getConversionMask());
    }
    ...
    public void testAdviceedOneDateFormat() {
        ...
        assertFalse(evaluator.getStringEvaluationResults().isEmpty());
        assertTrue(evaluator.getAdvicedResult().getConversionMeta().isDate());
        assertEquals(sampleLongFormat, evaluator.getAdvicedResult().getConversionMeta().getConversionMask());
        // should advice short format
        assertEquals(sampleShortFormat, evaluator.getAdvicedResult().getConversionMeta().getConversionMask());
    }
