...
public class ValueMetaBaseTest {
    ...
    public void testGetValueFromSQLTypeTypeOverride() throws Exception {
        ...
        verify(databaseInterface, times(1)).customizeValueFromSQLType(any(ValueMetaInterface.class), any(ResultSetMetaData.class), anyInt());
    }
    ...
    public void testConvertDataFromStringToString() throws KettleValueException {
        ...
        outValueMetaString.setEmptyStringAndNullAreDifferent(false);
        ...
        outValueMetaString.setEmptyStringAndNullAreDifferent(true);
        result = outValueMetaString.convertDataFromString(inputValueEmptyString, inValueMetaString, nullIf, ifNull, trim_type);
    ...
    public void testGetTrimTypeByDesc() {
        assertEquals(ValueMetaBase.getTrimTypeByDesc(BaseMessages.getString(PKG, "ValueMeta.TrimType.None")), ValueMetaInterface.TRIM_TYPE_NONE);
        assertEquals(ValueMetaBase.getTrimTypeByDesc(BaseMessages.getString(PKG, "ValueMeta.TrimType.Left")), ValueMetaInterface.TRIM_TYPE_LEFT);
        assertEquals(ValueMetaBase.getTrimTypeByDesc(BaseMessages.getString(PKG, "ValueMeta.TrimType.Right")), ValueMetaInterface.TRIM_TYPE_RIGHT);
        assertEquals(ValueMetaBase.getTrimTypeByDesc(BaseMessages.getString(PKG, "ValueMeta.TrimType.Both")), ValueMetaInterface.TRIM_TYPE_BOTH);
    ...
    public void testGetTrimTypeDesc() {
        assertEquals(ValueMetaBase.getTrimTypeDesc(ValueMetaInterface.TRIM_TYPE_NONE), BaseMessages.getString(PKG, "ValueMeta.TrimType.None"));
        assertEquals(ValueMetaBase.getTrimTypeDesc(ValueMetaInterface.TRIM_TYPE_LEFT), BaseMessages.getString(PKG, "ValueMeta.TrimType.Left"));
        assertEquals(ValueMetaBase.getTrimTypeDesc(ValueMetaInterface.TRIM_TYPE_RIGHT), BaseMessages.getString(PKG, "ValueMeta.TrimType.Right"));
        assertEquals(ValueMetaBase.getTrimTypeDesc(ValueMetaInterface.TRIM_TYPE_BOTH), BaseMessages.getString(PKG, "ValueMeta.TrimType.Both"));
    ...
    public void testConvertStringToTimestampType() throws KettleValueException {
        ...
        ValueMetaTimestamp metaTimestamp = new ValueMetaTimestamp("ValueMetaTimestamp");
        metaTimestamp.setConversionMask(ValueMetaBase.DATE_FORMAT_MYSQL);
        base.setConversionMetadata(metaTimestamp);
