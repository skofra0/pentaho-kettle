...
public class OracleDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public static final String DEEM_ORACLE_NLS_LENGTH_SEMANTICS = "ORACLE_NLS_LENGTH_SEMANTICS"; // SKOFRA
    public static final String ORACLE_NLS_LENGTH_SEMANTICS = System.getProperty(DEEM_ORACLE_NLS_LENGTH_SEMANTICS, ""); // CHAR or BYTE // SKOFRA
    protected static List<String> stringDbLookupIgnore = Collections.emptyList(); // SKOFRA
            ...
            case ValueMetaInterface.TYPE_STRING:
                if (length >= DatabaseMeta.CLOB_LENGTH) {
                    ...
                    if (length == 1) {
                        ...
                        // retval.append("VARCHAR2(").append(length).append(')'); // SKOFRA
                        retval.append("VARCHAR2(").append(length).append(nlsLengthSematics).append(')'); // SKOFRA
                    } else {
                        if (length <= 0) {
    ...
    public String[] getReservedWords() {
        return new String[] {"ACCESS", "ADD", "ALL", "ALTER", "AND", "ANY", "ARRAYLEN", "AS", "ASC", "AUDIT", "BETWEEN", "BY", "CHAR", "CHECK", "CLUSTER", "COLUMN", "COMMENT", "COMPRESS", "CONNECT", "CREATE", "CURRENT", "DATE", "DECIMAL", "DEFAULT", "DELETE", "DESC", "DISTINCT", "DROP", "ELSE", "EXCLUSIVE", "EXISTS", "FILE", "FLOAT", "FOR", "FROM", "GRANT", "GROUP", "HAVING", "IDENTIFIED", "IMMEDIATE", "IN", "INCREMENT", "INDEX", "INITIAL", "INSERT", "INTEGER", "INTERSECT", "INTO", "IS",
                "LEVEL", "LIKE", "LOCK", "LONG", "MAXEXTENTS", "MINUS", "MODE", "MODIFY", "NOAUDIT", "NOCOMPRESS", "NOT", "NOTFOUND", "NOWAIT", "NULL", "NUMBER", "OF", "OFFLINE", "ON", "ONLINE", "OPTION", "OR", "ORDER", "PCTFREE", "PRIOR", "PRIVILEGES", "PUBLIC", "RAW", "RENAME", "RESOURCE", "REVOKE", "ROW", "ROWID", "ROWLABEL", "ROWNUM", "ROWS", "SELECT", "SESSION", "SET", "SHARE", "SIZE", "SMALLINT", "SQLBUF", "START", "SUCCESSFUL", "SYNONYM", "SYSDATE", "TABLE", "THEN", "TO", "TRIGGER",
