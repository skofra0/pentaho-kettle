...
public class OracleDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public static final String DEEM_ORACLE_NLS_LENGTH_SEMANTICS = "ORACLE_NLS_LENGTH_SEMANTICS";

    public static final String ORACLE_NLS_LENGTH_SEMANTICS = System.getProperty(DEEM_ORACLE_NLS_LENGTH_SEMANTICS, ""); // CHAR or BYTE
    ...
    @Override
    public String getFieldDefinition(ValueMetaInterface v, String tk, String pk, boolean useAutoinc, boolean add_fieldname, boolean add_cr) {
