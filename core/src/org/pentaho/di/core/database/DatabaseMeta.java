...
public class DatabaseMeta extends SharedObjectBase implements Cloneable, XMLInterface, SharedObjectInterface,
  ...
  */
  ...
  public void addOptions() {
    ...
    PluginInterface infoBrightPlugin = PluginRegistry.getInstance().getPlugin(DatabasePluginType.class,
  ...
  public String getQuotedSchemaTableCombination(String schemaName, String tableName) {
    if (Const.isEmpty(schemaName)) {
      if (Const.isEmpty(getPreferredSchemaName())) {
        ...
        return databaseInterface.getSchemaTableCombination(quoteField(environmentSubstitute(getPreferredSchemaName())),
